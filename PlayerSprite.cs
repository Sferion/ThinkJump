...
namespace ThinkJump
{
    class PlayerSprite : Sprite
    {
            ...
            : base(newSpriteSheet, newCollisionTxr, newLocation)
        {
            ...
            animations[4].Add(new Rectangle(65, 60, 48, 52));
            animations[4].Add(new Rectangle(241, 60, 48, 52));
            animations[4].Add(new Rectangle(417, 60, 48, 52));                  //current work
            animations[4].Add(new Rectangle(611, 60, 48, 52));
            animations[4].Add(new Rectangle(792, 60, 48, 52));
            animations[4].Add(new Rectangle(973, 60, 48, 52));
            animations[4].Add(new Rectangle(1154, 60, 48, 52));
